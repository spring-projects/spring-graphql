...
public class ArgumentsBatchMethodArgumentResolver extends BatchHandlerMethodArgumentResolverSupport {
    ...
    public ArgumentsBatchMethodArgumentResolver(GraphQlArgumentBinder argumentBinder) {
    ...
    public <K> Object resolveArgument(MethodParameter parameter,
        ...
        return this.argumentBinder.bind(findFirstDataFetchingEnvironmentFromContexts(keyContexts), null, resolvableType);
    }
}
