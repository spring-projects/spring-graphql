 ...
 * with Query By Example support and register them as {@code DataFetcher}s for any
...
@ConditionalOnClass({GraphQL.class, ReactiveQueryByExampleExecutor.class })
@ConditionalOnBean(GraphQlSource.class)
@AutoConfigureAfter(GraphQlAutoConfiguration.class)
public class GraphQlWebFluxQueryByExampleAutoConfiguration {
	...
	public GraphQlSourceBuilderCustomizer reactiveQueryByExampleRegistrar(
		...
		return builder -> {
			List<ReactiveQueryByExampleExecutor<?>> executors =
