...
class GraphQlWebFluxSecurityAutoConfigurationTests {
	...
	void contributesExceptionResolver() {
		this.contextRunner.run((context) -> {
			assertThat(context).hasSingleBean(ReactiveSecurityDataFetcherExceptionResolver.class);
		});
	}
	...
	static class BookService {
		...
		@Nullable
		public Mono<Book> getBookdById(String id) {
			return Mono.justOrEmpty(GraphQlDataFetchers.getBookById(id));
		}
