...
public interface GraphQlTester {
	...
	/**
	 * Refer to an operation by name, where the given name is used to find a file
	 * with the same name and extension {@code ".graphql"} or {@code ".gql"} under
	 * classpath location {@code "graphql/"}.
	 * @param operationName The name of the file wherein the operation resides
	 * @return spec for response assertions
