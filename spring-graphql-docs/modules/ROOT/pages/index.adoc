...
Check the https://github.com/spring-projects/spring-graphql/wiki[Wiki] for the latest updates, baseline requirements, upgrade notes, and other cross-version information.
