...
Jackson library is on the classpath, JSON keyset will support the `Date`, `Calendar`,
`UUID`, Java Enums, `Number`, and any type from `java.time`.
...
include-code::KeysetCursorConfiguration[]
